...
# -------------------------------------------------------------------
arboles <- bagging_frwb_tree(training, regresores, etiqueta, 10)
# Esta lista contiene a 10 arboles
arboles
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
arboles <- bagging_bootstrap_tree(training, regresores, etiqueta, nrow(training), 10, RF_regresores = 4)
# Esta lista contiene a 10 arboles
arboles
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
arboles <- bagging_frwb_tree(training, regresores, etiqueta, 100, RF_regresores = 4)
# Esta lista contiene a 10 arboles
arboles
# -------------------------------------------------------------------
